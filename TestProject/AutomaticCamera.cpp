...
std::vector<std::vector<ControlPoint>> curves {
	...
	{
		{ glm::vec3(-121.109f, -0.348613f, 44.2004f), glm::vec3(-57.84f, -12.88f, 0.0f)			, 0.1 },
		{ glm::vec3(-73.8757f, -0.348613f, 86.7607f), glm::vec3(-30.08f, -8.64001f, 0.0f)		, 0.105 },
		{ glm::vec3(-3.14925f, -0.348613f, 101.657f), glm::vec3(2.55998f, -9.92001f, 0.0f)		, 0.11 },
		{ glm::vec3(75.4952f, 7.90453f, 73.9174f), glm::vec3(47.36f, -8.88001f, 0.0f)			, 0.115 },
		{ glm::vec3(102.009f, 12.828f, 51.9475f), glm::vec3(81.12f, -23.92f, 0.0f)				, 0.12 },
		{ glm::vec3(110.497f, 14.5025f, 12.1423f), glm::vec3(84.88f, -7.36001f, 0.0f)			, 0.125 },
		{ glm::vec3(110.558f, 15.6f, -18.3584f), glm::vec3(119.12f, -19.04f, 0.0f)				, 0.13 },
		{ glm::vec3(102.801f, 24.2902f, -54.9019f), glm::vec3(119.76f, -17.52f, 0.0f)			, 0.135 },
		{ glm::vec3(33.3217f, 24.2902f, -110.797f), glm::vec3(164.72f, -18.64f, 0.0f)			, 0.14 },
		{ glm::vec3(-34.7239f, 24.2902f, -114.123f), glm::vec3(198.801f, -17.28f, 0.0f)			, 0.145 },
		{ glm::vec3(-67.8184f, 20.52f, -72.105f), glm::vec3(244.161f, -14.96f, 0.0f)			, 0.15 },
		{ glm::vec3(-58.0856f, 16.3885f, -19.657f), glm::vec3(284.641f, -13.12f, 0.0f)			, 0.155 },
		{ glm::vec3(-23.5649f, 8.35816f, 8.85487f), glm::vec3(269.521f, -25.36f, 0.0f)			, 0.16 },
		{ glm::vec3(-2.68269f, -0.930763f, 17.7269f), glm::vec3(239.841f, -21.44f, 0.0f)		, 0.165 },
		{ glm::vec3(21.1806f, -9.55727f, 8.22238f), glm::vec3(352.961f, -11.28f, 0.0f)			, 0.17 },
		{ glm::vec3(12.647f, -13.2829f, -17.6487f), glm::vec3(386.881f, 13.6f, 0.0f)			, 0.175 },

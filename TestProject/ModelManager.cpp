...
{
	this->map = std::make_unique<Model>("../assets/Map/map.obj");
	...
	this->light = std::make_unique<Model>("../assets/Ball/ball.obj");
	...
	this->screenQuad = std::make_unique<Mesh>(screenQuadVertices, screenQuadIndices, screenQuadTextures);
